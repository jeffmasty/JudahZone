...
@Log4j
public class Drumkv2 implements Service {
	
	//private final ClickTrack clickTrack = null;
	
	@Getter private final String serviceName = Drumkv2.class.getSimpleName();
	...
	@Getter private static Drumkv2 instance;
	...
	public Drumkv2(File drumkit, String portname, boolean makeConnections) throws IOException, JackException {
	...
	public Drumkv2() throws IOException, JackException {
