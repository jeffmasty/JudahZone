...
public class MetroService implements Service, JackTimebaseCallback, JackSyncCallback {  
	...
	public MetroService() throws JackException {
	...
	class TickTock {
		...
		public void settings(Properties props) {
			...
			this.bpb = bpb;
			this.volume = gain;
			MetroService.this.props.put("bpm", bpm);
			MetroService.this.props.put("bpb", bpb);
			MetroService.this.props.put("volume", gain);
			metroUi.update();
	...
	public String getServiceName() {
		return MetroService.class.getSimpleName();
	}
