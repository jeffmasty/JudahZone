...
public class StereoBiquad {
	...
	public static enum FilterType 	{
		Gain("?"), LowPass("HiCut"), HighPass("LoCut"), Peaking("EQ");
	...
	public StereoBiquad(FilterType type, float frequency) { // 16Db Hi/Lo Pass,
		this(type, frequency, 2, 16f);
	}

	public StereoBiquad(int hz, float bandwidth) { // EQ left ch
		this(FilterType.Peaking, hz, bandwidth, 0f);
	}

	public StereoBiquad(BiquadF copy) { // EQ right ch
